...
export const createPromotion = async (req, res) => {
    try {
        const { title, subtitle, description, planId, discountedPriceMonthly, discountedPriceYearly, expiresAt, isPublished, bannerColor, badgeText, } = req.body;
...
export const updatePromotion = async (req, res) => {
    try {
        ...
        const { title, subtitle, description, planId, discountedPriceMonthly, discountedPriceYearly, expiresAt, isPublished, isActive, bannerColor, badgeText, } = req.body;
 ...
 */
export const togglePublishPromotion = async (req, res) => {
    try {
        const id = Number(req.params.id);
