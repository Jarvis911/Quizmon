...
jest.unstable_mockModule('../services/aiQuizVisualHydration.js', () => ({
    __esModule: true,
    hydrateAiQuizVisuals: jest.fn().mockResolvedValue(undefined),
    applyVisualsToRegeneratedRow: jest.fn().mockResolvedValue(undefined),
}));
...
describe('AI Routes', () => {
    ...
    describe('GET /ai/jobs', () => {
        it('should get all jobs for the user', async () => {
            ...
            prismaMock.aIGenerationJob.findMany.mockResolvedValue(mockJobs);
    ...
    describe('POST /ai/jobs', () => {
        it('should create a job and trigger generation successfully', async () => {
            ...
            prismaMock.aIGenerationJob.create.mockResolvedValue(mockJob);
            ...
            prismaMock.aIGenerationJob.update.mockResolvedValue({ ...mockJob, status: AIGenerationStatus.COMPLETED });
            prismaMock.aIGenerationJob.findUnique.mockResolvedValue(mockCompleteJob);
