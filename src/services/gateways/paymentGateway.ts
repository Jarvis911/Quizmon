...
const gatewayRegistry = new Map<PaymentMethod, PaymentGateway>();

export function registerGateway(method: PaymentMethod, gateway: PaymentGateway): void {
...
export function getAvailableGateways(): { method: PaymentMethod; name: string; available: boolean }[] {
    const allMethods: PaymentMethod[] = ['MOMO', 'VNPAY', 'STRIPE', 'MOCK'];
