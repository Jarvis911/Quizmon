 ...
 */
export function enterpriseEmailLayout(opts: EnterpriseLayoutOptions): string {
...
export function passwordChangedEmail(params: { displayName: string; changedAt: Date }): { subject: string; html: string } {
